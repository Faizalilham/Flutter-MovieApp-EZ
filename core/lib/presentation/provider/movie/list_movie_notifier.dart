...
import 'package:core/data/models/other/menu_item_drawer.dart';
...
class MovieListNotifier extends ChangeNotifier {
  ...
  List<MenuItems> data = [
    MenuItems(tittle: "Movie", icon: Image.asset("assets/img/popcorn.png",height: 20,width: 20,),route:HomeView.routeName),
    MenuItems(tittle: "Tv", icon:  Image.asset(
          "assets/img/monitor.png",
          height: 20,
          width: 20,
        ),route:TvPage.routeName),
    MenuItems(tittle: "Watchlist", icon:  Image.asset(
